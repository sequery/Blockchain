...
def new_wallet():
    ...
    if request.method == 'GET':
        ...
        cursor = con.cursor()
        cursor.execute(
            'INSERT INTO Client_List(Name,Surname,Public_Key,Private_Key,Login_Password,Time_Stamp) VALUES(?,?,?,?,?,?);',
            (Name, Surname, Private_Key, Public_Key, Login_Pass, Time_Stamp)
        )
        con.commit()
...
def generate_transaction():
    # TODO Database Names Instead Of Keys
    # TODO Update Database Budget
